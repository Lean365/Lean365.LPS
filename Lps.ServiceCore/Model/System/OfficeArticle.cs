namespace Lps.ServiceCore.Model.System
{
    /// <summary>
    /// 文章表
    /// </summary>
    [SugarTable("office_article", "文章管理")]
    [Tenant("0")]
    public class OfficeArticle
    {
        /// <summary>
        /// 文章id
        /// </summary>
        ...
        [Navigate(NavigateType.OneToOne, nameof(CategoryId), nameof(OfficeArticleCategory.CategoryId))] //自定义关系映射
