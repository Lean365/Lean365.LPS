...
VALUES ('主设变', 310010, 999, 'PpEcMaster', 'production/PpEcMaster', 0, 0, 'C', '0', '0', 'pp:ecmaster:list', 'icon1', 'system', GETDATE(), 'menu.PpEcMaster');
...
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+310010001,'zh-cn', 'menu.PpEcMaster', '主设变', GETDATE());

INSERT INTO sys_common_lang(id,lang_code, lang_key, lang_name, addtime) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+310010002,'zh-tw', 'menu.PpEcMaster', 'TW_主设变', GETDATE());

INSERT INTO sys_common_lang(id,lang_code, lang_key, lang_name, addtime) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+310010003,'en', 'menu.PpEcMaster', 'EN_主设变', GETDATE());

INSERT INTO sys_common_lang(id,lang_code, lang_key, lang_name, addtime) 
VALUES ((SELECT CAST(CAST(NEWID() AS VARBINARY(3)) AS INT))+310010004,'ja', 'menu.PpEcMaster', 'JA_主设变', GETDATE());